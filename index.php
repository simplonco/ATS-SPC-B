...
if(isset($_POST['Validate'])){
    ...
    if (empty($passcode)) {
        ...
        if ($user_id == 0) {
          ...
          // *********** //
          //$ARRIVAL_TIME = new DateTime($data['current_time']);
          ...
          $ABSENT_TIME = new DateTime('12:00:00');
            if ($ARRIVAL_TIME  > $LATE_TIME && $ARRIVAL_TIME < $ABSENT_TIME) {
                ...
                $errors[] = "Welcome but You will be considered as absent today".$ARRIVAL_TIME;
            } else {
                $success = "Welcome and Thank you<br />".$ARRIVAL_TIME;
            }
        }
    }
}
